...
def create_pdf_report(content):
    ...
    for section, text in content.items():
        ...
        pdf.cell(0, 10, section, 0, 1)  # Section title
        pdf.set_font("Arial", size=12)
        pdf.multi_cell(0, 10, text.strip())  # Section content
...
taste_trends_technology = st.text_area("Taste, Trends and Technology - How will the future affect your business?", key='taste_trends_technology')
...
potential_money_sources = st.text_area("Potential sources of money to start or expand your small business", key='potential_money_sources')
